...
export default function Hero() {
  return (
    <section
      id="hero"
      className="min-h-screen flex items-center justify-center px-6 py-6 lg:px-16 xl:px-24"
    >
      <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 lg:gap-24 items-center w-full">
        ...
        >
          ...
          >
            NOAN
            <br />
            <span className="text-gray-500 dark:text-gray-500 font-light">
              DELATOUCHE
            </span>
          </motion.h1>
        ...
        >
          <div className="relative">
            <div className="absolute inset-0 w-96 h-96 lg:w-[450px] lg:h-[450px] hidden lg:block">
              <svg
                className="w-full h-full hero-spider-web"
                viewBox="0 0 400 400"
                fill="none"
              >
                <g
            ...
            <div
              className="absolute top-4 right-8 w-4 h-4 bg-green-400 rounded-full hero-floating-dot shadow-lg"
              style={{ animationDelay: "0s" }}
            >
              <div className="absolute inset-0 bg-green-400 rounded-full animate-ping opacity-75"></div>
            </div>
            <div
              className="absolute bottom-8 right-4 w-3 h-3 bg-yellow-400 rounded-full hero-floating-dot shadow-lg"
              style={{ animationDelay: "1.5s" }}
            ></div>
            <div
              className="absolute bottom-16 left-8 w-2 h-2 bg-blue-400 rounded-full hero-floating-dot"
